...
t.prototype.u=function(){if(this.o)for(;this.o.length;)this.o.shift()()};/*
...
*/
var u=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};r("yt.config_",u);function w(a,b){return a in u?u[a]:b}

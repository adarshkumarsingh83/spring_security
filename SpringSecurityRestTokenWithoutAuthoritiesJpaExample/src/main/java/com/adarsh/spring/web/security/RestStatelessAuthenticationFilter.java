 ...
 */
public class RestStatelessAuthenticationFilter extends GenericFilterBean {

    private static final Logger log = LoggerFactory.getLogger(RestStatelessAuthenticationFilter.class);
    private TokenAuthenticationService tokenAuthenticationService;
    private static final String AUTH_HEADER_NAME = "X-AUTH-TOKEN";

    protected RestStatelessAuthenticationFilter(TokenAuthenticationService taService) {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        log.info("RestStatelessAuthenticationFilter doFilter()");
        /*
        ...
        if (((HttpServletRequest) req).getHeader(AUTH_HEADER_NAME) != null) {
            log.info("RestStatelessAuthenticationFilter doFilter() Token Found In Request Header");

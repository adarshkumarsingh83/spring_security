...
VALUES((SELECT ID FROM USER WHERE USERNAME='adarsh'),(SELECT ID FROM USERROLE WHERE NAME ='SUPER_ADMIN'))
     ,((SELECT ID FROM USER WHERE USERNAME='admin'),(SELECT ID FROM USERROLE WHERE NAME ='ADMIN'))
     ,((SELECT ID FROM USER WHERE USERNAME='user'),(SELECT ID FROM USERROLE WHERE NAME ='USER'));